...
<div class="text">
  ...
  <p class="poster" ><img src="../images/3.webp" width="140px" /></p>
  <div >
    
<p>Описание: </p>
<div >  Когда Джереми встречает Мелиссу, он сразу понимает, что она — Та Самая. Но хватит ли у него сил, чтобы побороться за любимую в самой безнадежной ситуации? Одна любовь может изменить твою жизнь. Одна жизнь может изменить целый мир. 
</div>
<br>
</div>
...
<div class="traler">
<p>Трейлер: </p>
<iframe width="560" height="315" src="../trailer/Верю в любовь.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=9   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilmaa\" value=\"9\" >

  <textarea name=\"comment\" ></textarea>

  <input type = \"text\" name=\"ssilk\" class=\"idfilmaa\" value=\"films/Film4.php\" >
