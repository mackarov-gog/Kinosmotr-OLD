...
<div class="text">
  ...
  <p class="poster" ><img src="../images/7.webp" width="140px" /></p>
  <div >
    
<p>Описание: </p>
 <div >  Если у вас есть вопрос по оплате, обратитесь к нашим специалистам по телефону 
</div>
<br>
</div>
...
<div class="traler">
<p>Трейлер: </p>
<iframe width="560" height="315" src="../trailer/Отель Белград.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=13   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilmaa\" value=\"13\" >

  <textarea name=\"comment\" ></textarea>

  <input type = \"text\" name=\"ssilk\" class=\"idfilmaa\" value=\"films/Film8.php\" >
