...
<p>Побег из Шоушенка</p>
  ...
  <p class="poster" ><img src="../images/17.webp" width="140px" /></p>
  <div >
    
<p>Описание: </p>
  <div> Бухгалтер Энди Дюфрейн обвинён в убийстве собственной жены и её любовника. Оказавшись в тюрьме под названием Шоушенк, он сталкивается с жестокостью и беззаконием, царящими по обе стороны решётки. Каждый, кто попадает в эти стены, становится их рабом до конца жизни. Но Энди, обладающий живым умом и доброй душой, находит подход как к заключённым, так и к охранникам, добиваясь их особого к себе расположения. </div>
<br>
</div>

<div class="traler">
<p>Трейлер: </p>
<iframe width="560" height="315" src="../trailer/Побег из Шоушенка.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=18   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilma\" value=\"18\" >

  <textarea name=\"comment\" ></textarea>

  <input type = \"text\" name=\"ssilk\" class=\"idfilma\" value=\"films/Film17.php\" >
...
$sql = "SELECT * FROM bilet where  idfilm=18   ";
$result = mysqli_query($link, $sql);
