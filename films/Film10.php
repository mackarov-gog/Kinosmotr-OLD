...
<div class="text">
  ...
  <p class="poster" ><img src="../images/9.webp" width="140px" /></p>
  <div >
    
    
<p>Описание: </p>
  <div > Мир ждал героя, и появился ёжик. Способный бегать со сверхзвуковой скоростью, Соник должен спасти Землю и не дать злому доктору Роботнику завладеть мировым господством.
</div>
<br>
</div>
...
<div class="traler">
<p>Трейлер: </p>
<iframe width="560" height="315" src="../trailer/Соник в кино.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=15   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilmaa\" value=\"15\" >

  <textarea name=\"comment\" ></textarea>

  <input type = \"text\" name=\"ssilk\" class=\"idfilmaa\" value=\"films/Film10.php\" >
