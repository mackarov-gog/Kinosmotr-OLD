...
<div class="text">
  ...
  <p class="poster" ><img src="../images/16.webp" width="140px" /></p>
  <div >
    
<p>Описание: </p>
  <div> Оставшиеся в живых члены команды Мстителей и их союзники должны разработать новый план, который поможет противостоять разрушительным действиям могущественного титана Таноса. После наиболее масштабной и трагической битвы в истории они не могут допустить ошибку. </div>
<br>
</div>

<div class="traler">
<p>Трейлер: </p>
<iframe width="560" height="315" src="../trailer/Мстители Финал .mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=22   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilmaa\" value=\"22\" >

  <textarea name=\"comment\" ></textarea>

  <input type = \"text\" name=\"ssilk\" class=\"idfilmaa\" value=\"films/Film16.php\" >
...
<input type = "number" name="idfilma" class="idfilmaa" value="21" >
