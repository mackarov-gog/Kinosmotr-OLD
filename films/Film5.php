...
<p>Вперед</p>
  ...
  <p class="poster" ><img src="../images/4.webp" width="140px" /></p>
  <div >
    
<p>Описание: </p>
 <div >  Когда-то давно в сказочном мире царила магия, но после открытия электричества маги стали не нужны, и развитие пошло по техногенному пути. Теперь эльфы, тролли, гоблины, мантикоры, феи, кентавры и единороги летают на самолетах, пользуются автомобилями и мобильниками и ведут в целом прозаичную жизнь.
...
<div class="traler">
<p>Трейлер: </p>
<iframe width="560" height="315" src="../trailer/Вперёд.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=10   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilma\" value=\"10\" >

  <textarea name=\"comment\" ></textarea>

  <input type = \"text\" name=\"ssilk\" class=\"idfilma\" value=\"films/Film5.php\" >
...
$sql = "SELECT * FROM bilet where  idfilm=10   ";
$result = mysqli_query($link, $sql);
