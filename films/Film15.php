...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=21   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilmaa\" value=\"21\" >
  ...
  <input type = \"text\" name=\"ssilk\" class=\"idfilmaa\" value=\"films/Film15.php\" >
