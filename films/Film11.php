...
<div class="text">
  ...
  <p class="poster" ><img src="../images/11.webp" width="140px" /></p>
  <div >
    
<p>Описание: </p>
  <div> Молодой воришка по имени Аладдин хочет стать принцем, чтобы жениться на принцессе Жасмин. Тем временем визирь Аграбы Джафар намеревается захватить власть над Аграбой, а для этого он стремится заполучить волшебную лампу, хранящуюся в пещере чудес, доступ к которой разрешен лишь тому, кого называют «алмаз неограненный», и этим человеком является не кто иной, как сам Аладдин. </div>
<br>
</div>

<div class="traler">
<p>Трейлер: </p>
<iframe width="560" height="315" src="../trailer/Аладдин.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=16   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilmaa\" value=\"16\" >

  <textarea name=\"comment\" ></textarea>

  <input type = \"text\" name=\"ssilk\" class=\"idfilmaa\" value=\"films/Film11.php\" >
