...
<div class="traler">
<p>Трейлер: </p>
<iframe width="560" height="315" src="../trailer/Гретель и Гензель.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
$sql = "SELECT * FROM `otziv`,polzov WHERE login=polz and  idfilm=11   ";
$result = mysqli_query($link, $sql);
...
<input type = \"number\" name=\"idfilma\" class=\"idfilmaa\" value=\"11\" >

  <textarea name=\"comment\" ></textarea>

  <input type = \"text\" name=\"ssilk\" class=\"idfilmaa\" value=\"films/Film6.php\" >
